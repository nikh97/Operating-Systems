...
public class FCFS{
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		if(detailed) System.out.println("This detailed printout gives the state and remaining burst for each process");
		System.out.println();

	    FCFS(processes, detailed);
	}

	public static void FCFS(ArrayList<Node> processes, boolean detailed){
